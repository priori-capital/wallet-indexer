...
const main = async () => {
  ...
  for (const collection of collections) {
    ...
    await idb.none(updateActivitiesQuery, { collection });
    ...
    await idb.none(updateUserActivitiesQuery, { collection });
    ...
    await idb.none(cleanAttributesQuery, { collection });
    ...
    await idb.none(cleanAttributeKeysQuery, { collection });
    ...
    await idb.none(cleanTokenSetsQuery, { collection });
